...
@Component({
  selector: 'app-oracle-cloud-partnership',
  templateUrl: './oracle-cloud-partnership.component.html',
  styleUrls: ['./oracle-cloud-partnership.component.scss']
})
export class OracleCloudPartnershipComponent {
  constructor() {
    //small
