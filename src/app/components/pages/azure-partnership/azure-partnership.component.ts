...
@Component({
  selector: 'app-azure-partnership',
  templateUrl: './azure-partnership.component.html',
  styleUrls: ['./azure-partnership.component.scss']
})
export class AzurePartnershipComponent implements OnInit {
  constructor() {
    //small
