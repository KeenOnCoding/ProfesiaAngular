...
@Component({
  selector: 'app-well-architected',
  templateUrl: './well-architected.component.html',
  styleUrls: ['./well-architected.component.scss']
})
export class WellArchitectedComponent implements OnInit {
  constructor() {
    //small
